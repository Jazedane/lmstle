...
<div class="card">
    <div class="card-body text-center">
        <div class="admin-index-form-size">
            ...
            <form id="login_form" class="form-signin" method="post" action="/lmstle/signup_new.php">
...
<?php } else {
        ...
        mysqli_query(
            $conn,
            "insert into activity_log (date,username,action) values(NOW(),'$username','Add User $username')"
        ) or die(mysqli_error());
        ?>
<script>
