...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2023 at 03:18 PM
...
(34, 'Hapon', '2023-01-01 21:20:33', 'Add User Hapon'),
(35, 'Kilat', '2023-01-14 15:02:47', 'Add User Kilat'),
(36, 'Kilat', '2023-01-14 15:05:43', 'Add User Kilat'),
(37, 'ADMIN', '2023-01-14 21:12:43', 'Edit Teacher ADMIN'),
(38, 'Ten', '2023-01-14 21:12:50', 'Edit Teacher Ten'),
(39, 'Pon', '2023-01-14 21:58:44', 'Add User Pon'),
(40, 'ADMIN', '2023-01-14 22:10:39', 'Edit Teacher ADMIN');
...
(854, 'The Task <b>Project 2</b> has been graded. You received a grade of <b>20</b>.', 'submit_task.php?id=60&post_id=212', '2023-01-08 15:18:45', 1234, 91, 0),
(855, 'The Task <b>Project 3</b> has been graded. You received a grade of <b>15</b>.', 'submit_task.php?id=60&post_id=213', '2023-01-08 15:19:26', 1234, 91, 0);
...
(1234, 'ADMIN', '23908401df1c879155ba712ab94b383e6db1d25c064ae5e1b285928e7792f8da', 'ROSALIE', 'P', 'JAENA', 'admin@admin.com', '', '', 'Bug-Ang, Toboso', '2022-10-12', 'FEMALE', 9123456788, 'TLE', 'Filipino', 'received_472195831476549.webp', '', 'ACTIVATED', 0, 1),
...
--
ALTER TABLE `tbl_class`
  MODIFY `class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2274;
...
--
ALTER TABLE `tbl_notification`
  MODIFY `notification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=856;
...
--
ALTER TABLE `tbl_student_task`
  MODIFY `student_task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `tbl_teacher_class`
  MODIFY `teacher_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT for table `tbl_teacher_class_student`
--
ALTER TABLE `tbl_teacher_class_student`
  MODIFY `teacher_class_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;

--
-- AUTO_INCREMENT for table `tbl_teacher_log`
--
ALTER TABLE `tbl_teacher_log`
  MODIFY `teacher_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
COMMIT;
