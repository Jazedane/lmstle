...
(2257, 'GRADE 9 - DAY', 9, 'day', 0),
(2258, 'GRADE 8 - NIGHT', 8, 'NIGHT', 0),
(2259, 'GRADE 8 - NO', 8, 'NO', 1);
...
(350, 1234, 'Hey', '2022-11-24 10:24:29', 58, 'ROSALIE JAENA', 'TIN TIN', ''),
(351, 58, 'Hi                               ', '2022-11-24 10:27:14', 1234, 'TIN TIN', ' ', ''),
(352, 1234, 'Hi', '2022-11-24 10:27:37', 58, 'ROSALIE JAENA', 'TIN TIN', ''),
...
(231, 58, 'Hey', '2022-11-24 10:24:15', 1234, 'TIN TIN', 'ROSALIE JAENA'),
(232, 1234, 'Hey', '2022-11-24 10:24:29', 58, 'ROSALIE JAENA', 'TIN TIN'),
(233, 58, 'Hi                               ', '2022-11-24 10:27:14', 1234, 'TIN TIN', ' '),
...
(571, 'New Activity Added: <b>Test</b>', 'task_student.php?id=29', '2022-11-24 21:45:33', 1234, 65, 0),
...
(90, 'J', 'J', 'MALE', 20, '0000-00-00', '', 0, '', '', 2257, '12-3333', '70d574699c5b8426bea134d480f2e7ac2800bfb7d79fae5b8cc5b31287b094f2', 'uploads/NO-IMAGE-AVAILABLE.jpg', 'Registered', 0),
...
(1263, 'Benten', '6700869c8ff7480e34a70a708b028700dbaa3a033b5652b903afe89f49a31456', 'BEN', 'TEN', '', '', '', '', '0000-00-00', 'Female', 0, '', '', 'NO-IMAGE-AVAILABLE.jpg', '', 'Activated', 0);
...
(56, 1242, 2232, 123, '/lmstlee4/admin/uploads/thumbnails.png', 1, 0),
(57, 1242, 2257, 123, '/lmstlee4/admin/uploads/thumbnails.png', 1, 0),
(58, 1242, 2258, 123, '/lmstlee4/admin/uploads/thumbnails.png', 1, 0),
(59, 1242, 2259, 123, '/lmstlee4/admin/uploads/thumbnails.png', 1, 0);
...
--
ALTER TABLE `tbl_class`
  MODIFY `class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2260;

--
-- AUTO_INCREMENT for table `tbl_grade_category`
--
ALTER TABLE `tbl_grade_category`
  MODIFY `grade_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;

--
-- AUTO_INCREMENT for table `tbl_message`
--
ALTER TABLE `tbl_message`
  MODIFY `message_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=356;

--
-- AUTO_INCREMENT for table `tbl_message_sent`
--
ALTER TABLE `tbl_message_sent`
  MODIFY `message_sent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=238;

--
-- AUTO_INCREMENT for table `tbl_notification`
--
ALTER TABLE `tbl_notification`
  MODIFY `notification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=576;
...
--
ALTER TABLE `tbl_student_task`
  MODIFY `student_task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `tbl_task`
  MODIFY `task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;

--
-- AUTO_INCREMENT for table `tbl_teacher`
--
ALTER TABLE `tbl_teacher`
  MODIFY `teacher_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1264;

--
-- AUTO_INCREMENT for table `tbl_teacher_class`
--
ALTER TABLE `tbl_teacher_class`
  MODIFY `teacher_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT for table `tbl_teacher_class_student`
--
ALTER TABLE `tbl_teacher_class_student`
  MODIFY `teacher_class_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT for table `tbl_teacher_log`
--
ALTER TABLE `tbl_teacher_log`
  MODIFY `teacher_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
