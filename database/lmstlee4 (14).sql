...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2022 at 05:09 PM
...
(30, 'FB_IMG_15752132410870857.jpg', 'Okra', 'okra');
...
(471, 'New Activity Added: Activity 7', 'task_student.php?id=29', '2022-11-12 15:17:59', 1234, 58, 0),
...
(494, 'submit activity name <b>Activity 3</b>', 'view_submit_task.php?id=28&post_id=182', '2022-11-13 00:22:57', 46, 1234, 0),
(495, 'submit activity name <b>Activity 3</b>', 'view_submit_task.php?id=28&post_id=182', '2022-11-13 00:23:55', 46, 1234, 0),
...
(58, 'Tin', 'Tin', 'MALE', 18, '2010-07-13', 'Caduha-an', 9123456789, 'jaze@gmail.com', 'Filipino', 2232, '22-0060', 'ab547757da37eb600011051fb0e9fe0c9ea49d220086a939c76369d29bfa1542', 'uploads/NO-IMAGE-AVAILABLE.jpg', 'Registered', 0),
...
(81, 'uploads/sample.docx', '2022-08-15 01:24:32', 'Task1', 1, 0, '2022-10-01 00:00:00', 123, 2223, 'Task number 1', 0, 0, 1),
(181, '', '2022-11-12 23:37:51', '', 0, 0, '2022-11-25 12:01:00', 1234, 28, 'Activity 2', 50, 200, 0),
(182, '', '2022-11-12 23:51:22', '', 0, 0, '2022-11-18 12:01:00', 1234, 28, 'Activity 3', 30, 200, 0),
(183, '', '2022-11-13 23:41:03', 'Sample', 0, 0, '2022-11-19 12:01:00', 1234, 29, 'Sample', 40, 207, 0);
...
(1234, 'ADMIN', '23908401df1c879155ba712ab94b383e6db1d25c064ae5e1b285928e7792f8da', 'ROSALIE', 'JAENA', 'admin@admin.com', '', '', 'Toboso', '2022-11-13', 'Female', 9123456789, 'TLE', 'Filipino', 'received_472195831476549.webp\r\n', '', 'Activated', 0),
...
(261, 'Admin', '2022-11-12 15:03:09', '', 1234),
(262, 'Admin', '2022-11-12 23:16:32', '', 1234),
(263, 'Admin', '2022-11-13 18:25:04', '', 1234);
...
--
ALTER TABLE `tbl_activity_log`
  MODIFY `activity_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `tbl_grade_category`
  MODIFY `grade_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;
...
--
ALTER TABLE `tbl_student_task`
  MODIFY `student_task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `tbl_task`
  MODIFY `task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=184;
...
--
ALTER TABLE `tbl_teacher_class`
  MODIFY `teacher_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `tbl_teacher_class_student`
--
ALTER TABLE `tbl_teacher_class_student`
  MODIFY `teacher_class_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

--
-- AUTO_INCREMENT for table `tbl_teacher_log`
--
ALTER TABLE `tbl_teacher_log`
  MODIFY `teacher_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=264;
