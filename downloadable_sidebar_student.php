	...
	<div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="fa-solid fa-plus-circle"></i> Add Downloadable</h4></div>
                            </div>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <button name="Upload" type="submit" value="Upload" class="btn btn-info" /><i class="fa-solid fa-upload"></i> Upload</button>
                            </div>
                        </div>
                    </form>
