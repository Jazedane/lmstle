...
<body>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        ...
                        <a tabindex="-1" href="avatar_modal_student.php" data-toggle="modal"><i
                                class="fa-solid fa-image-portrait"></i> Change Avatar</a>
    ...
    <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" role="menu" data-accordion="false" data
            ...
            <li class=""><a href="my_classmates.php<?php echo '?id='.$get_id; ?>"><i class="fa-solid fa-user-group"></i>
                    My Classmates</a></li>
