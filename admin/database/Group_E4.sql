...
(1, 'admin', '2022-08-15 10:00:01', 'Add Student 1234567');
...
INSERT INTO `task_update` (`assignment_id`, `floc`, `fdatein`, `fdesc`, `teacher_id`, `class_id`, `fname`) VALUES
(1, 'uploads/sample.docx', '2022-08-16 11:00:01', 'abcdf', 1, 1, 'Task Number 1')
...
(1, 'admin/uploads/sample.pdf', '2022-08-15 09:00:01', 'abcd', 1, 1, 'Task1', 'TLE-Teacher');
...
(1, 1, 'hello', '2022-08-15 12:00:01', 1, 'Admin Admin', 'Juzztine Mañapao', '')
...
(1, 1, 'world', '2022-08-15 12:00:01', 1, 'Admin Admin', 'Juzztine Mañapao', '')
...
(1, 1, 'Add file name <b>sss</b>', '2022-08-15 12:00:01', 'downloadable_student.php')
...
(1234567, 'Jaze ', 'Dane', 1, 'Jazedane', 'jazedane', 'uploads/NO-IMAGE-AVAILABLE.jpg', 'Registered');
...
(1, 1, 'admin/uploads/sample.pdf', '2022-08-15 10:00:04', 'hello', 'Task1', 1234, '');
...
(1, 'admin/uploads/sample.docx', '2022-08-15 10:00:04', 'test', 2, 'test'),
...
INSERT INTO `subject` (`subject_id`, `subject_code`, `subject_title`, `category`, `description`,`Pre_req`, `semester`) VALUES
(1, 'TLE9', 'Technology, Livelihood and Education', '', '', 1, '', '2nd'),
...
(1, 'Admin', 'admin', 'Admin', 'Admin', 'uploads/NO-IMAGE-AVAILABLE.jpg', '', '', 'Activated'),
...
(1, 1234, 1, 1, 'admin/uploads/thumbnails.jpg', '2022-2023'),
...
(1, 1, 'Submit Assignment file name <b>my_assginment</b>', '2013-11-25 10:39:52', 'view_submit_assignment.php', 93, 16),
...
(1, 1234, 1, 'admin/uploads/sample.jpg', '2022-08-15 09:00:01', 'sas', 'sss');
...
(1, 'admin', '2022-08-16 12:00:33', '2022-08-16 12:33:00', 1);
--
...
--
ALTER TABLE `student_updated_task`
  ADD PRIMARY KEY (`file_id`);
...
--
ALTER TABLE `teacher_updated_task`
  ADD PRIMARY KEY (`file_id`);
