               ...
               <div class="span12">
                   <form method="post">
                       <div class="control-group">
                           <div class="controls">
                               <input name="class_name" value="<?php echo $row['class_name']; ?>" class="input focused"
                                   id="focusedInput" type="text" placeholder="Class Name" required>
                           </div>
                       </div>
                       ...
                       <div class="control-group">
                           <div class="controls">
                               ...
                               <a href="class.php" class="btn btn-info"><i class="fa-solid fa-add"></i> Add Class</a>
                           </div>
                       </div>
                   </form>
               </div>
