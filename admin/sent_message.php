                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class="active">
										<a href="create_message_teacher.php"><i class="fa-solid fa-envelope"></i> Sent messages</a>
										</li>
										</ul>
								...
								<?php }}else{ ?>
								<div class="alert alert-info"><i class="fa-solid fa-info-circle"></i> No Message in your Sent Items</div>
								<?php } ?>
                                </div>
                            </div>
                        </div>
