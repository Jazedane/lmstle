                    ...
                    <div class="col-md-12">
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                <form class="mt-5" action="category.php" method="post" enctype="multipart/form-data" name="upload">
                            ...
                            <div class="card-footer">
                                <center>
                                    ...
                                    <input type="reset" class="btn btn-danger " id="reset" name="reset" value="Cancel">
                                </center>
                            </div>
                        </div>
                    </div>
