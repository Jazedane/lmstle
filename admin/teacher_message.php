                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								 ...
								 ?>
											...
											<i class="fa solid fa-calendar"></i> <?php echo $row['date_sended']; ?>
													<div class="pull-right">
														<a class="btn btn-link"  href="#reply<?php echo $id; ?>" data-toggle="modal" ><i class="fa-solid fas-reply"></i> Reply </a>
													</div>
													<div class="pull-right">
								...
								<?php }}else{ ?>
								<div class="alert alert-info"><i class="fa-solid fa-info-circle"></i> No Inbox  Messages</div>
								<?php } ?>	
                                </div>
                            </div>
                        </div>
