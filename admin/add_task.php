				...
				$("#add_downloadble").submit(function(e){
					...
					$.ajax({
						...
						success: function(html){
							$.jGrowl("Task Successfully Added", { header: 'Task Added' });
			...
			<div class="alert alert-info">Check The Class you want to put this file.</div>
						...
						<?php } ?>
								...
								<hr>
									...
									<div class="control-group">
												<div class="controls">
													<button name="Upload" type="submit" value="Upload" class="btn btn-success" /><i class="fa-solid fa-upload"></i>&nbsp;Upload</button>
												</div>
									</div>
									</center>
