                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="fa-solid fa-plus-circle"></i> Add class</h4></div>
                            </div>
								...
								<form method="post" id="add_class">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
												<button name="save" class="btn btn-success"><i class="fa-solid fa-save"></i> Save</button>
                                          </div>
                                        </div>
                                </form>
