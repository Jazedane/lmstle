                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  								<div class="alert alert-info"><i class="fa-solid fa-info-circle"></i> Please Fill in required details</div>
								<?php
								...
								?>								
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										...
										<div class="control-group">
											<div class="controls">
											<button type="submit" class="btn btn-info"><i class="fa-solid fa-save"></i> Save</button>
											</div>
										</div>
									</form>
