...
mysqli_query($conn,"insert into tbl_teacher_class (teacher_id,subject_id,class_id,thumbnails,school_year) values('$session_id','$subject_id','$class_id','/lmstlee4/admin/uploads/thumbnails.png','$school_year')")or die(mysqli_error());
