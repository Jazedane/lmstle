            ...
            <div class="block-content collapse in">
                <div class="span12">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="create_message_teacher.php">For Student</a>
                        </li>
                    </ul>
                    ...
                    <form method="post" id="send_message">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="student_id" class="chzn-select" required>
                                    ...
                                    <option value="<?php echo $row['student_id']; ?>"><?php echo $row['firstname']; ?>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button class="btn btn-info"><i class="fa-solid fa-envelope"></i> Send </button>
