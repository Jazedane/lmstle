					<!-- class delete modal -->
					<div id="class_delete" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<div id="student_delete" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					    <div class="modal-dialog">
					        <div class="modal-content bg-danger">
					            <div class="modal-header">
					                <h4 id="myModalLabel" class="modal-title">Delete Student?</h4>
					                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					                    <span aria-hidden="true">&times;</span>
					                </button>
					            </div>
					            ...
					            <div class="modal-footer justify-content-between">
					                <button class="btn" data-dismiss="modal" class="btn btn-outline-light"><i class="fas fa-times"></i>
					                    Close</button>
					                <button name="delete_student" class="btn btn-danger toastrDefaultSuccess"><i
					...
					<div id="teacher_delete" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					    <div class="modal-dialog">
					        <div class="modal-content bg-danger">
					            <div class="modal-header">
					            ...
					            <div class="modal-footer justify-content-between">
					                <button class="btn" data-dismiss="modal" class="btn btn-outline-light"><i class="fas fa-times"></i>
					                    Close</button>
					                <button name="delete_teacher" class="btn btn-danger"><i class="fas fa-check"></i>
					                    Yes</button>
					            </div>
					        </div>
					    </div>
					...
					<div id="subject_delete" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
					    ...
					    <div class="modal-footer">
					        <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="fa-solid fa-remove"></i>
					            Close</button>
					        <button name="delete_subject" class="btn btn-danger"><i class="fa-solid fa-check"></i> Yes</button>
					    </div>
					</div>