					...
					<div id="class_delete" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
					    ...
					    <div class="modal-footer">
					        <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="fa-solid fa-remove"></i>
					            Close</button>
					        <button name="delete_class" class="btn btn-danger"><i class="fa-solid fa-check"></i> Yes</button>
					    </div>
					</div>
					...
					<div id="student_delete" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
					    ...
					    <div class="modal-footer">
					        <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="fa-solid fa-remove"></i>
					            Close</button>
					        <button name="delete_student" class="btn btn-danger"><i class="fa-solid fa-check"></i> Yes</button>
					    </div>
					</div>
					...
					<div id="teacher_delete" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
					    ...
					    <div class="modal-footer">
					        <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="fa-solid fa-remove"></i>
					            Close</button>
					        <button name="delete_teacher" class="btn btn-danger"><i class="fa-solid fa-check"></i> Yes</button>
					    </div>
					</div>
					...
					<div id="content_delete" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
					    ...
					    <div class="modal-footer">
					        <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="fa-solid fa-remove"></i>
					            Close</button>
					        <button name="delete_content" class="btn btn-danger"><i class="fa-solid fa-check"></i> Yes</button>
					    </div>
					</div>
