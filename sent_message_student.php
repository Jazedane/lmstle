                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class=""><a href="student_message.php"><i class="fa-solid fa-info-circle"></i>Inbox</a></li>
										<li class="active"><a href="sent_message_student.php"><i class="fa-solid fa-envelope"></i>Send messages</a></li>
										</ul>
								...
								<?php }}else{ ?>
								<div class="alert alert-info"><i class="fa-solid fa-info-circle"></i> No Message in your Send Items</div>
								<?php } ?>	
                                </div>
                            </div>
                        </div>
