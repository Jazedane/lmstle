                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
  					...
  					<form action="read.php" method="post">
						<?php if($not_read == '0'){
							...
							<button id="delete"  class="btn btn-info" name="read"><i class="fa-solid fa-check"></i> Read</button>
					...
					?>
									<div class="post"  id="del<?php echo $id; ?>">
										...
										<hr>
										<div class="pull-right">
										<i class="fa-solid fa-calendar"></i>&nbsp;<?php echo $row['date_of_notification']; ?> 
										</div>
					...
					?>
					<div class="alert alert-info"><strong><i class="fa-solid fa-info-circle"></i> No Notifications Found</strong></div>
					<?php
					}
					?>
