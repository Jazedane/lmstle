                        ...
                        <div id="block_bg" class="block">
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								<?php
									...
									$count = mysqli_num_rows($query);	
								if ($count == '0'){ ?>
								<div class="alert alert-info"><i class="fa-solid fa-info-circle"></i> No Task Currently Uploaded.</div>
								<?php
								}else{
								?>
									...
									<a data-toggle="modal" href="#user_delete" id="delete"  class="btn btn-info" name=""><i class="fa-solid fa-copy"></i> Copy Check item to backpack</a>
									...
									?>                              
										...
										<td width="30">
                                         ...
                                         <td width="30">
										 <a  data-placement="bottom" title="Download" id="<?php echo $id; ?>Download" href="<?php echo $row['floc']; ?>"><i class="fa-solid fa-download"></i> Download</a>
										 </td>            
