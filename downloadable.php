                        ...
                        <div class="block-content collapse in">
                            <div id="downloadable_table.php" class="span12">
                                ...
                                <?php
										...
										if ($count == '0'){ ?>
                                <div class="alert alert-info"><i class="fa-solid fa-info-circle"></i> Currently you did
                                    not upload any task materials</div>
